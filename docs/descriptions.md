...
#### Во всех тестах далее размер доски при инициализации указывать 5 на 5
...
* _Входные данные_: Начальные координаты w, h в пределах границ доски, а именно с клетки отличной от (0, 0) находящейся в пределах доски.
* _Ожидаемый результат_: Алгоритм завершает работу без ошибок начиная проход со стандартной точки (0, 0) и проходит через все клетки доски.
